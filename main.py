...
c.body_color = 'SeaGreen1'

body = c.create_oval(35,20,365,350,outline=c.body_color , fill=c.body_color)
foot_left = c.create_oval(65,320,145,360 , outline=c.body_color , fill=c.body_color)
foot_right = c.create_oval(250,320,330,360 , outline=c.body_color , fill=c.body_color)

ear_left = c.create_oval(60,40,125,100,outline=c.body_color , fill=c.body_color)
ear_right = c.create_oval(275,40,335,100,outline=c.body_color , fill=c.body_color)

eye_left = c.create_oval(115,115,175,170,outline='black', width=2 , fill='white')
pupil_left = c.create_oval(140,145,150,155,outline='black' , fill='black')
eye_right = c.create_oval(215,115,275,170,outline='black', width=2 , fill='white')
